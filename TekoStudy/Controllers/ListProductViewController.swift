...
extension ListProductViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let productDetailViewController = ProductDetailViewController.instantiate(storyboard: .main)
        productDetailViewController.productId = products[indexPath.row].sku
